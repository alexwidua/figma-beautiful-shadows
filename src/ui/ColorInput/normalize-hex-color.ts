/**
 * @file Forked from https://github.com/yuanqing/create-figma-plugin/blob/main/packages/ui/src/components/textbox/textbox-color/private/normalize-hex-color.ts
 */
