		...
		<div className={styles.parameters}>
			<TextboxNumeric
				...
				onInput={(e: JSX.TargetedEvent<HTMLInputElement>) =>
					setTempAzimuth(e.currentTarget.value)
				}
				value={tempAzimuth}
				suffix={'°'}
			...
			<TextboxNumeric
				...
				icon={'D'}
				onInput={(e: JSX.TargetedEvent<HTMLInputElement>) =>
					setTempDistance(e.currentTarget.value)
				}
				value={tempDistance}
			...
			<TextboxNumeric
				...
				onInput={(e: JSX.TargetedEvent<HTMLInputElement>) =>
					setTempElevation(e.currentTarget.value)
				}
				value={tempElevation}
				suffix={'%'}
...
const IconElevation16 = ({ v = 0 }) => {
	return (
		<svg
			...
			xmlns="http://www.w3.org/2000/svg">
			<path
				d="M8 7L15 11L8 15L1 11L8 7Z"
				fill="currentColor"
				style={{ opacity: 0.8 }}
			/>
			<path
				d={`M2 ${v + 6}L8 ${v + 2}.5L14 ${v + 6}L8 ${v + 9}.5L2 ${
					v + 6
				}Z`}
				fill="white"
				stroke="currentColor"
